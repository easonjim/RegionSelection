namespace RegionSelection.Model {
    	using System;
    	...
    	public partial class Region : MySoft.Data.Entity {
    		...
    		protected override MySoft.Data.Table GetTable() {
    			return new MySoft.Data.Table<Region>("Region");
    		}
    		...
    		public override bool Equals(object obj) {
    			...
    			if ((false == typeof(Region).IsAssignableFrom(obj.GetType()))) {
    				return false;
    			}
    		...
    		public class _ {
    			...
    			/// 表示选择所有列，与*等同
    			/// </summary>
    			public static MySoft.Data.AllField All = new MySoft.Data.AllField<Region>();
    			
    			/// <summary>
    			/// 字段名：id - 数据类型：Int64
    			/// </summary>
    			public static MySoft.Data.Field id = new MySoft.Data.Field<Region>("id");
    			
    			/// <summary>
    			/// 字段名：display - 数据类型：String
    			/// </summary>
    			public static MySoft.Data.Field display = new MySoft.Data.Field<Region>("display");
    			
    			/// <summary>
    			/// 字段名：name - 数据类型：String
    			/// </summary>
    			public static MySoft.Data.Field name = new MySoft.Data.Field<Region>("name");
    			
    			/// <summary>
    			/// 字段名：parentId - 数据类型：Int64(可空)
    			/// </summary>
    			public static MySoft.Data.Field parentId = new MySoft.Data.Field<Region>("parentId");
    			
    			/// <summary>
    			/// 字段名：shortName - 数据类型：String
    			/// </summary>
    			public static MySoft.Data.Field shortName = new MySoft.Data.Field<Region>("shortName");
    			
    			/// <summary>
    			/// 字段名：type - 数据类型：Int32(可空)
    			/// </summary>
    			public static MySoft.Data.Field type = new MySoft.Data.Field<Region>("type");
    		}
    	}
    }
